module DesignSystem
  module Atoms
    ...
    class ButtonComponentPreview < ViewComponent::Preview
      ...
      def default(variant: "primary", style: "", content: "Button", icon: nil, placement: "start", class_name: "", size: "md")
        ...
        render(BuildoutDesignSystem::Atoms::ButtonComponent.new({ variant: variant, style: style, size: size, icon: icon, placement: placement, class_name: class_name })) do
          content
        end
      end

      # @param path "Link Path"
      def link(variant: "primary", style: "", content: "Button", icon: nil, placement: "start", class_name: "", size: "md", path: "https://google.com")
        render(BuildoutDesignSystem::Atoms::ButtonComponent.new({ variant: variant, style: style, size: size, icon: icon, placement: placement, class_name: class_name , path: path})) do
          content
        end
      end
